...
from system.admintype import AdminType as at
        ...
        try:
            if self.logged_in_admin.type in (type for type in at):
                with sqlite3.connect(self.__admin_db) as conn:
                    ...
                    _cursor = conn.cursor()
                    try:
                        _cursor.execute(self.commands.get_all_admins)
                    except sqlite3.OperationalError:
                        return it.TABLE_NOT_FOUND
                    else:
...
admin  = Admin() # an admin object
# data to use in creating an admin account
data = (
           'sammy', # username
           'Samuel', # firstname
           'Bug', # lastname
...
# print(admin.create_account(data))
print(admin.login_admin("jona", "heavenboy"))
#pprint(admin.show_permissions())
# print(admin._delete_user('guppy'))
print(admin.block_user('teddbug'))
print(admin.search_user('teddbug'))
print(f"Users count: {admin.get_users_count()}")
print(f"Admins count: {admin.get_admins_count()}\n\n")
print(admin._clear_database())
print(admin.search_user('teddbug'))
#print(f"All users: {admin.get_all_users()}\n\n")
#print(f"All admins: {admin.get_all_admins()}")
